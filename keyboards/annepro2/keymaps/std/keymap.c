 ...
 const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     TO(BASE2),        KC_MS_L,    KC_MS_D,    KC_MS_R,    KC_WH_D,    _______,           _______,        _______, _______, _______,  KC_PGUP,       KC_PGDN,       _______,
  ...
  */
     ...
     KC_ESC,                  KC_1,          KC_2,       KC_3,       KC_4,       KC_5,       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_MINUS,   KC_EQUAL,     KC_BSPC,
                              KC_TAB,        KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_LBRC,        KC_RBRC,        KC_BSLS,
                              MO(FN3),       KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,        KC_ENT,
                              KC_LSFT,       KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
                              KC_LCTL,       KC_LGUI,    KC_LALT,    KC_SPC,     KC_RALT,    MO(FN4),    KC_F12,     KC_RCTL
     ),
     /*
      * Layer FN1
      * ,-----------------------------------------------------------------------------------------.
      ...
      *
      */
     [FN4] = LAYOUT_60_ansi( /* FN2 */
     KC_AP2_BT_UNPAIR, KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_AP2_BT4, KC_AP_RGB_TOG,     KC_AP_RGB_MOD,  RGB_HUI, RGB_HUD, RGB_SAI,  RGB_SAD, KC_AP_RGB_VAI, KC_AP_RGB_VAD, KC_DEL,
     _______,          KC_BTN1,    KC_MS_U,    KC_BTN2,    KC_WH_U,    _______,           _______,        _______, RGB_SPI, RGB_SPD,  KC_PSCR,       KC_HOME,       KC_END,        _______,
     TO(BASE),          KC_MS_L,    KC_MS_D,    KC_MS_R,    KC_WH_D,    _______,           _______,        _______, _______, _______,  KC_PGUP,       KC_PGDN,       _______,
     _______,          _______,    _______,    _______,    _______,    _______,           _______,        _______, AC_TOGG, KC_INS,   KC_DEL,        _______,
     _______,          _______,    _______,                                               _______,                   _______,         _______,       _______,       _______
     )
 };
